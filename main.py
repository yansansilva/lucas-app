...
if lista_resultados != []:
    for x in range(len(lista_resultados)):
        ...
        if data[0] != data[1]:
            nomearquivo = coluna_nomear_arquivo_1.text_input('Digite um nome para o arquivo:', f'{lista_arquivos[x].name}_medição_de_{data[0]}_a_{data[1]}')
        else:
            nomearquivo = coluna_nomear_arquivo_1.text_input('Digite um nome para o arquivo:', f'{lista_arquivos[x].name}_medição_de_{data[0]}')
